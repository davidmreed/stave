...
urlpatterns = [
    ...
    path('_/<slug:league>/<slug:event>/', view=views.EventDetailView.as_view(), name="event-detail"),
    path('_/<slug:league>/<slug:event>/<slug:application_form>/', views.ApplicationFormView.as_view(), name="application-form"),
    path('_/<slug:league>/<slug:event>/<slug:application_form>/applications/', views.FormApplicationsView.as_view(), name="form-applications"),
