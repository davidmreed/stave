...
class Command(BaseCommand):
    ...
    def handle(self, *_args, **_kwargs):  # type: ignore
        ...
        _role_jr = role_group_so.roles.get(name="JR", order_key=3)
        _role_jr2 = role_group_so.roles.get(name="JR", order_key=4)
        _role_opr = role_group_so.roles.get(name="OPR", order_key=5)
        _role_opr2 = role_group_so.roles.get(name="OPR", order_key=6)
        _role_opr3 = role_group_so.roles.get(name="OPR", order_key=7)
        _role_altref = role_group_so.roles.get(name="ALT", order_key=8)
